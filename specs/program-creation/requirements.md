...
- After saving basic program data, methods may be auto-suggested
- **Polling required**: Wait for method suggestions to be populated
- User can:
...
- [ ] Program is saved to Postgres (syncs to Airtable via outbox)
...
- Existing Goals API endpoint
- Existing Days API endpoint
- Existing Methods API endpoint
- Program creation API endpoint
