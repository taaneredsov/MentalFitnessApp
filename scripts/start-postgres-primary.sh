...
export DATA_BACKEND_OVERTUIGING_USAGE="${DATA_BACKEND_OVERTUIGING_USAGE:-postgres_primary}"
export DATA_BACKEND_REWARDS="${DATA_BACKEND_REWARDS:-postgres_primary}"
export DATA_BACKEND_METHODS="${DATA_BACKEND_METHODS:-postgres_primary}"
export DATA_BACKEND_OVERTUIGINGEN="${DATA_BACKEND_OVERTUIGINGEN:-postgres_primary}"
export DATA_BACKEND_PERSONAL_GOALS="${DATA_BACKEND_PERSONAL_GOALS:-postgres_primary}"
export DATA_BACKEND_PERSOONLIJKE_OVERTUIGINGEN="${DATA_BACKEND_PERSOONLIJKE_OVERTUIGINGEN:-postgres_primary}"
...
export USER_WEBHOOK_SYNC_ENABLED="${USER_WEBHOOK_SYNC_ENABLED:-true}"
export AIRTABLE_USER_SYNC_SECRET="${AIRTABLE_USER_SYNC_SECRET:-changeme}"
