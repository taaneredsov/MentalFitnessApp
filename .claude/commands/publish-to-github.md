...
This returns both values, e.g., `taaneredsov/json-anything taaneredsov`

Store the results as:

- `{repository}` - Full repo name (e.g., `taaneredsov/json-anything`)
- `{owner}` - Repository owner (e.g., `taaneredsov`)
